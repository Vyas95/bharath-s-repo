...
// SDM volume 3, section 24.6.2 table 24-6
...
// SDM volume 3, section 24.6.2, table 24-7

struct capability_info proc2based[25] =
{
   ...
   {22, "Mode-basedexecute control for EPT"},
...
detect_vmx_features(void)
{
	...
	pr_info("Secondary Processor based Controls MSR: 0x%llx\n",
		(uint64_t)(lo | (uint64_t)hi << 32));
	report_capability(proc2based, 25, lo, hi);
